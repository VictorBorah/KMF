						...
						<div class="graph">
							<div class="block-page">
								<form name="newPlanFrm" id="newPlanFrm" > 
									...
									<input type="hidden" name="intvID" id="intvID" value="8" />
									...
									<div class="col-xs-12 col-md-6 appCol">
										...
										<div class="form-group">
											<input type="radio" name="planType" id="invPlan" value="1"  checked />&nbsp;Investment Plan&nbsp;&nbsp;
											<input type="radio" name="planType" id="loanPlan" value="2" />&nbsp;Loan Plan
										</div>
										...
										<div class="form-group"> 
											<label for="planAmt">Total Plan Amount</label> 
											<input type="text" class="form-control" id="planAmt" name="planAmt" placeholder="0.00" > 
										</div> 
										
										<div class="form-group"> 
											<label for="interestAmt">Interest Amount</label> 
											<input type="text" class="form-control" id="interestAmt" name="interestAmt" placeholder="0.00" > 
										</div> 		
									...
									<div class="col-xs-12 col-md-6">
										<div class="form-group"> 
											...
											<input type="text" class="form-control" id="installmentAmt" name="installmentAmt" value="0.00" readonly> 
										</div> 									
									
										<div class="form-group"> 
											<label for="planVal">Total Plan Value</label> 
											<input type="text" class="form-control" id="planVal" name="planVal" value="0.00" readonly style="color:#d93600"> 
										</div> 
