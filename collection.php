...
<html>
<head>
<title>Collection | Kunja Micro Finance</title>
								...
								<div class="tables">
									<table class="table table-bordered datatable" style="width:100%;"> 
										...
										<tbody> 											
											...
											$getPlanClients = "SELECT * FROM client_plan_map  ";
											foreach ($coreConn->query($getPlanClients) as $dRow)
											{
												$map_PK = $dRow['id'];
												$plan_PK = $dRow['planID'];
												$cid = $dRow['clientID'];
												...
												<tr>
													...
													<td>
														<a id="k-<?php echo $map_PK;?>-<?php echo $clientName;?>-<?php echo $plan_PK;?>"  href="#" class="blueBtn collectBTN">Collect</a>
													</td>
												</tr>
												<?php 
												$i++;
...
<script src="js/kmf.collection.js"></script>
</body>
</html>