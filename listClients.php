...
<html>
<head>
<title>List Clients | Kunja Micro Finance</title>
								...
								<div class="tables">
									<table class="table table-bordered datatable" style="width:100%;"> 
										...
										<tbody> 											
											<?php 
											$i=1;
											$getDurations = "SELECT * FROM tbl_clients  ";
											foreach ($coreConn->query($getDurations) as $dataRow)
											{
												...
												<tr>
													<td><?php echo $i;?></td>
													<td><a href="viewClient?xuiki9w2v=<?php echo $dataRow['id'];?>"><?php echo $dataRow['clentName'];?></a></td>
													<td><?php echo $dataRow['clientMobile'];?></td>
													<td><?php echo $dataRow['clientAddress'];?></td>
													<td><?php echo $dataRow['clientEmail'];?></td>
													<td><?php echo $sex;?></td>												
													<td><?php echo $activeStts;?></td>												
													<td>
														<a href="editClient?uu9ikx3vp=<?php echo $dataRow['id'];?>" class="orangeBtn">Edit</a>
													</td>
													<td>
														<a target="_blank" href="viewClient?xuiki9w2v=<?php echo $dataRow['id'];?>" class="blueBtn">View</a>
													</td>
												</tr>
												<?php 
												$i++;
...
<script src="js/kmf.listClients.js"></script>
</body>
</html>