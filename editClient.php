...
if( isset($_GET['uu9ikx3vp']) )
{
	$clientID = $_GET['uu9ikx3vp'];
...
<html>
<head>
<title>Edit Client | Kunja Micro Finance</title>
							...
							<div class="block-page">
								<form name="ClientFrm" id="ClientFrm" > 
									...
									<div class="form-group"> 
										...
										<input type="text" class="form-control" id="clientName" name="clientName"  value="<?php echo $clientName;?>"  placeholder="Client Full Name"> 
									</div> 
																		
									
									<div class="form-group"> 
										<label for="clientMobile">Client Mobile</label> 
										<input type="text" class="form-control" id="clientMobile" name="clientMobile" value="<?php echo $clientMobile;?>" placeholder="Client Mobile"> 
									</div>
									
									<div class="form-group"> 
										<label for="clientEmail">Client Email</label> 
										<input type="text" class="form-control" id="clientEmail" name="clientEmail" value="<?php echo $clientEmail;?>" placeholder="Client Email"> 
									</div>
									
									<div class="form-group"> 
										<label for="clientAddress">Client Address</label> 
										<textarea class="form-control" name="clientAddress" id="clientAddress"><?php echo $clientAddress;?></textarea>					
									</div>
									...
									<div class="form-group"> 
										...
										<select name="clientSex" id="clientSex" class="form-control1">
									...
									<div class="form-group"> 
										<label for="clientPlans">Associated Plan(s)<span style="color:#b30000;">*</span></label> 
									...
									<div class="form-group" style="margin-top:30px;">
										<div class="row" style="margin:10px 0 0 0;">Client Photo</div>
										<div class="col-xs-12">											
											<div class="row">
								...
								<button type="button" id="editClient" class="btn btn-default">Update Client</button> 
							</div>						
						</div>					
				</div>				
			</div>
