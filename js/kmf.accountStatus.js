...
$('.datatable').DataTable({
	...
	*/
	...
	$(document).on("click", '.openRcptWindow', function(e){
		var rid=this.id;
		...
		receiptPane = jsPanel.create({
			...
			footerToolbar:"<button id='printRcpt' class='btn btn-primary'>Print</button>&nbsp;<button id='getPDF' class='btn btn-info'>PDF</button>&nbsp;<button type='button' id='closeModal' class='btn btn-danger pull-right closeViewWIn'>Close</button>",	
			panelSize: {
			...
			onwindowresize: true,
			headerTitle: 'Transactions Receipt',
			contentFetch:
			{
				resource: 'Controllers/trReceiptWindow?policyNum='+dataID,
				beforeSend: function()
				{
				...
				done: function (panel, response) 
				{
					...
					receiptPane.setHeaderTitle("Policy Number: "+dataID);
	...
	$(document).on("click", '#getPDF', function(e){
		...
		var fileName = $("#policy_NUM").val();
		var custName = $("#cust_Name").val();
		var element = document.getElementById('PrintWin');
		
		var opt = {filename:  custName+'-'+fileName+'.pdf',}
	...
	$(document).on("click", '#printRcpt', function(e){
	...
	function printData()
	{
	   var divToPrint=document.getElementById("PrintWin");
	   newWin= window.open("");
